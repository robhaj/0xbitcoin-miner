...
cmd_binding_gyp_gpuminer_target_cuda_on_linux_0 = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj).$(TOOLSET)/gpuminer/geni; nvcc -Xcompiler -fpic -c -o "$(obj).$(TOOLSET)/gpuminer/geni/cuda_sha256d.o" "$(abspath $<)"
