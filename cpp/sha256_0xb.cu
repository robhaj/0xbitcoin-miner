...
/*
This seems to begin a thread !
You put your work in the 'work' struct

Finished hashes are spit out of  hashes_done
	...
	do {
		...
		*hashes_done = pdata[19] - first_nonce + throughput;
		...
		if (work->nonces[0] != UINT32_MAX)
		{
			...
			else if (vhash[7] > ptarget[7]) { // if the hash is larger than the target ? bad nonce?
